...
### *16 Prompts for Midjourney / DALL-E*

<br>

> *The following prompts are optimized for generative AI image tools. Each corresponds to a figure placeholder in the preceding editorial phases. They focus on architectural concrete, macro textile weaves, high-fashion minimalist posing, and blueprint-style sketches. Lighting: sharp geometric shadows and soft natural gallery light.*

<br>

---

### PROMPT 01 — The Architect's Table *(for FIGURE 01)*
...
### PROMPT 02 — The Debossed Name *(for FIGURE 02)*

```
Extreme close-up of the word "LEGOH" debossed 0.5mm deep into heavy off-white cotton
...
### PROMPT 03 — The Logo Concepts *(for FIGURE 04)*

```
Three logo concepts for a luxury fashion house, hand-drawn in dark volcanic-brown ink
on heavy cotton rag paper 400gsm. Each logo is a different typographic arrangement of
the words "ROSEMARY LEGOH" — one with portal-like vertical bars flanking the name, one
...
### PROMPT 05 — The RL Fold Editorial Hero *(for FIGURE 06)*
...
### PROMPT 06 — The Macro Weave *(for FIGURE 07)*

```
Extreme macro photograph of hand-woven ATBM Indonesian batik textile. Individual cotton
threads visible — warp and weft intersecting at 90 degrees with slight hand-irregular
...
cream. No processing, no filters. Shot on 100mm macro lens.
ultra-high definition, hyper-realistic, maximum detail. Aspect ratio: Square (1:1). Style: Raw
```

---

### PROMPT 07 — The Unboxing Ritual *(for FIGURE 08)*
...
single accent of deep red-brown wax. ultra-high definition,
...
brass. ultra-high definition, hyper-realistic, maximum detail.
Aspect ratio: Landscape (3:2). Style: Raw
```

---

### PROMPT 09 — The Sold-Out Moment *(for FIGURE 10)*

```
Editorial lifestyle photograph. A woman's hand holds a smartphone displaying an Instagram
Story — a dark screen with white serif text reading "Drop 01. 30 Pieces. Sold Out." In the
background, slightly out of focus: a cream rigid box on a raw wood table with a loosely
...
### PROMPT 10 — The Mobile Scarcity UI *(for FIGURE 11)*

```
Product photography mockup. Two smartphones side by side on a warm sand-colored linen
surface. Left phone displays an Instagram Story: a backlit silhouette of a woman wearing
a structured asymmetric collar coat, text overlay "The RL Fold." Right phone displays a
...
### PROMPT 11 — The Fold Construction Blueprint *(for FIGURE 12)*

```
Technical architectural blueprint-style drawing of an asymmetric origami collar
construction. White lines on deep indigo background. Five labeled zones marked with
...
Small annotation text in a monospaced font. ultra-high definition,
hyper-realistic, maximum detail. Aspect ratio: Landscape (3:2). Style: Raw
```

---

### PROMPT 12 — The Weaver's Hands *(for FIGURE 13)*

```
Documentary-style photograph of an Indonesian woman's hands working at a narrow wooden
ATBM handloom. Her fingers are threading a shuttle loaded with indigo-dyed cotton through
taut cream-colored warp threads. The loom is old, made of dark teak, with visible wear
...
shadows. Peter Lindbergh documentary influence. ultra-high definition,
hyper-realistic, maximum detail. Aspect ratio: Portrait (4:5). Style: Raw
```

---

### PROMPT 13 — The Split Composition *(for FIGURE 03)*
...
### PROMPT 14 — The Colour Palette Swatches *(for FIGURE 14)*

```
Studio product photograph of three vertical colour palette swatch strips arranged side
by side on 400gsm off-white paper. Left strip labelled "Threshold Edition" — four swatches:
limestone warm white, charcoal wood near-black, deep sea near-navy, bronze patina accent.
Centre strip labelled "Colonnade Edition" — four swatches: red earth terracotta-brown, aged
ivory, mangrove sea green-black, antique gold. Right strip labelled "Parang Grid Edition"
...
border. Large-format camera. ultra-high definition,
hyper-realistic, maximum detail. Aspect ratio: Landscape (3:2). Style: Raw
```

---

### PROMPT 15 — The Heritage Note & Wax Seal Card *(for FIGURE 15)*

```
Flat-lay editorial photograph on a raw aged-oak surface. A folded bi-fold card in 300gsm
off-white stone paper lies open showing two interior panels — left panel typeset with
...
### PROMPT 16 — The Power Poses Storyboard *(for FIGURE 16)*
...
* **Paper:** Matte Art Paper (210gsm for interior / 300gsm for cover).
* **Color:** Rich Black (CMYK) for all text and architectural lines.
* **Binding:** Saddle Stitch (stapled) with a clean trim.
